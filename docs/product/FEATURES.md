...
|---|---|---|---|---|---|---|---|---|
| `FEAT-1` | Payroll calculation trace auditability | Ensuring trace entries name the derivation source for a value, not just the value, so an auditor never needs to re-query live DB state. | `CAP-1` | Correctness, Audit & Snapshot | `active` | `STORY-0029`, `STORY-0031`, `STORY-0042`, `STORY-0075`, `STORY-0097`, `STORY-0145`, `STORY-0167` | 7 | 7 |
| `FEAT-26` | Period & rule snapshot integrity | Freezing the rule set, period context and proration strategy a run was calculated against. | `CAP-1` | Correctness, Audit & Snapshot | `active` | `STORY-0030`, `STORY-0043`, `STORY-0112`, `STORY-0164`, `STORY-0165` | 5 | 5 |
...
| `FEAT-34` | Input validation & enum guards | Allowlist and enum validation, length guards, generic error messages, logging hygiene. | `CAP-2` | Security & Compliance Hardening | `active` | `STORY-0077`, `STORY-0083`, `STORY-0084`, `STORY-0085`, `STORY-0087`, `STORY-0166` | 6 | 6 |
...
| `FEAT-6` | Client onboarding & workspace creation | Workspace creation, country-code validation, pay-cycle guards, onboarding Excel ingestion. | `CAP-3` | Onboarding & Workspace Setup | `active` | `STORY-0011`, `STORY-0013`, `STORY-0060`, `STORY-0174` | 4 | 4 |
...
| `FEAT-8` | Enrollment & payroll readiness | Enrollment flow, pre-population, readiness badges, activation CTAs, readiness-service correctness. | `CAP-4` | Employee Lifecycle Management | `active` | `STORY-0104`, `STORY-0110`, `STORY-0118`, `STORY-0122`, `STORY-0129`, `STORY-0130`, `STORY-0171` | 7 | 7 |
...
| `FEAT-19` | Statutory deduction correctness | PAYE on taxable income and its statutory bands, NHF/health/levy, non-taxable class, PAYE-only additions, check-off dues, NSITF/ITF, life insurance. | `CAP-6` | Execution Engine | `active` | `STORY-0007`, `STORY-0023`, `STORY-0078`, `STORY-0079`, `STORY-0080`, `STORY-0081`, `STORY-0082`, `STORY-0131`, `STORY-0156`, `STORY-0169` | 10 | 10 |
| `FEAT-20` | Proration & period handling | Partial-period proration; workspace-configurable hire and termination strategy. | `CAP-6` | Execution Engine | `active` | `STORY-0005`, `STORY-0086`, `STORY-0168` | 3 | 3 |
...
| `FEAT-29` | Run state machine & approval | Forward-only progression, DB trigger enforcement, dedup, Approve/Lock/Mark-paid. | `CAP-7` | Governance & Run State Machine | `active` | `STORY-0008`, `STORY-0009`, `STORY-0024`, `STORY-0175` | 4 | 4 |
...
| `FEAT-31` | Statutory & payroll rule versioning | Statutory `effective_from` UNIQUE, payroll rule versioning and auto-publish, WITHDRAWN status. | `CAP-7` | Governance & Run State Machine | `active` | `STORY-0026`, `STORY-0132`, `STORY-0136`, `STORY-0162`, `STORY-0163` | 5 | 5 |
...
| `FEAT-33` | Payment & statutory exports | Bank upload, PAYE remittance, pension schedule, full payroll detail. | `CAP-8` | Disbursement & Exports | `active` | `STORY-0058`, `STORY-0068`, `STORY-0069`, `STORY-0070`, `STORY-0172`, `STORY-0173` | 6 | 6 |
...
| `FEAT-37` | Test harness & regression coverage | Fixture scaffold, financial-engine tests, API/migration tests, async-contract rewrites. | `CAP-10` | Delivery Infrastructure | `active` | `STORY-0139`, `STORY-0140`, `STORY-0141`, `STORY-0142`, `STORY-0144`, `STORY-0170` | 6 | 6 |
...
| `FEAT-42` | Product record & roadmap structure | `docs/ROADMAP.md` / `docs/PLAN.md` split; forward-item traceability coverage. | `CAP-11` | Programme Governance & Assurance | `active` | `STORY-0158`, `STORY-0159`, `STORY-0160`, `STORY-0161`, `STORY-0176` | 5 | 5 |

**Totals:** 42 features · **161 migrated · 161 allocated — no backlog remaining** (D-030 / `roadmap-split`, 2026-07-29).
...
- **2026-07-29 (D-030, Phase 6):** `FEAT-42` — *Product record & roadmap structure* — added under `CAP-11`. The first shape change since the programme entered steady state, and the first to run through the "new phase + human decision" rule that state defines. It exists because the `roadmap-split` sprint's four stories are about the structure of the product record itself, which `FEAT-40` (review programmes) and `FEAT-41` (sprint workflow model) do not cover. No existing feature, capability, outcome or story assignment changed.
- **2026-07-29 (`roadmap-split` STORY-0160):** feature story-counts updated across the tree by the forward-coverage batch — open roadmap items that had no `STORY-<nnnn>` were allocated one and entered as `status: backlog`. An addition under the steady-state provision, not a shape change.
