# `STORY-0159` — Create `docs/PLAN.md` with one labelling scheme
...
person planning the next sprint
...
- `docs/PLAN.md` exists and contains **only** not-yet-delivered work: the open Phase 1 items, plus Phase 2 (Agent Layer) and Phase 3 (Platform Scale).
...
- No delivered work appears in `PLAN.md`; no open work is reachable only from `ROADMAP.md`.
