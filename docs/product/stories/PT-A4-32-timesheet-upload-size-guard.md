# `PT-A4-32` — SEC-S7: 10 MB server-side timesheet upload size guard

**Outcome:** `OUT-2` (see `../OUTCOMES.md`)
**Capability:** `CAP-2` (see `../CAPABILITIES.md`)
**Feature:** `FEAT-2` (see `../FEATURES.md`)
