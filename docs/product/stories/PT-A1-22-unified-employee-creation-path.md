# `PT-A1-22` — Unified employee creation path via `employee_repo` (B2, Sprint 17)
...
- Commit `0ed5bfb` (2026-05-27) — same commit as `PT-A1-21`; B1 and B2 were delivered together in Sprint 17 Track B.
...
Depends on `PT-A1-21` (`employee_repo` must exist before `onboarding.py` can be refactored to call it) — both delivered in the same commit.
