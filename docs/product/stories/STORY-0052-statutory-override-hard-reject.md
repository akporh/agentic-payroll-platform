# `STORY-0052` — Statutory component hard reject on override PATCH (D-ARCH-2, WC-10)

**Origin code(s):** `PT-A1-16` · `D-ARCH-2` · `WC-10`
...
Shares its implementation with `STORY-0050` (was `PT-A1-11`) (WC-10/11 edit/toggle UI) — this is the backend compliance-guard half of the same PATCH endpoint. Depends on `STORY-0051` (was `PT-A1-15`)'s migration for the `is_active` column it is guarding.
