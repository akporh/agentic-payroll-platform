# `STORY-0130` — Workspace activation CTA reachable from 3 landing points

**Origin code(s):** `PT-A1-39` · `WS-ACTIVATE-1/2/3`
...
- Commit `98f2100` (2026-06-15) — same bundled commit as `STORY-0129` (was `PT-A1-38`); this fix and the EMP-REG-5 fix shipped together with Sprint 27/28.
