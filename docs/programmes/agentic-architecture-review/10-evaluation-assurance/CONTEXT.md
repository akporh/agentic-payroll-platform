...
context-ready (populated 2026-07-17 by the controller on Stage 09's closure — critic PASS, report in `09-human-experience/outputs/critic-review.md`)
...
**Run the Stage 10 primary-executor pass per `RUNBOOK.md`.**
